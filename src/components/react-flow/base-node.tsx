...
import { CircleCheck, Loader2Icon, XCircleIcon } from "lucide-react";
...
export function BaseNode({
  ...
  return (
    ...
    >
      ...
      {status === "success" && <CircleCheck className="absolute right-0.5 bottom-0.5 size-2 text-emerald-700 stroke-3" />}
