...
interface GeminiDialogProps {
  ...
  onSubmit: (values: IGeminiFormSchema) => void;
  defaultValues?: Partial<IGeminiFormSchema>;
}
...
export const GeminiDialog = ({
  ...
  const handleSubmit = (values: IGeminiFormSchema) => {
    onSubmit(values);
    onOpenChange(false);
  };
          ...
          <ScrollArea className="max-h-100 p-4">
            <FieldGroup>
              ...
              <FormSelect
                ...
                description="The Google Gemini model to use for completion"
              >
